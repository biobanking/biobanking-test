These notes are for the EDITORS of obib
...
Make sure you have an ID range in the [idranges file](obib-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [obib-edit.owl](obib-edit.owl)

** DO NOT EDIT obib.obo OR obib.owl in the top level directory **

[../../obib.owl](../../obib.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/biobanking/biobanking-test) for details.
 ...
 * [obib-idranges.owl](obib-idranges.owl)
...
This generates derived files such as obib.owl and obib.obo and places
 ...
 * https://github.com/biobanking/biobanking-test/releases
 * https://github.com/biobanking/biobanking-test/releases/new
...
what is in the `owl:versionIRI` of the derived obib.owl (`data-version` in
obib.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/obib.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/obib/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/biobanking/biobanking-test.svg?branch=master)](https://travis-ci.org/biobanking/biobanking-test)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/biobanking](https://travis-ci.org/profile/biobanking)
 2. click the "Sync account" button
 3. Click the tick symbol next to biobanking-test
