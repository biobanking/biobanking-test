 ...
 * [obib.yml](obib.yml)
     * Determines how your purl.obolibrary.org/obo/obib/ redirects will be handled
     ...
     * Paste in the contents of [obib.yml](obib.yml)
 ...
 * [obib.md](obib.md)
     ...
     * Paste in the contents of [obib.md](obib.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
